...
import io.synadia.source.NatsPayloadSourceBuilder;
import io.synadia.source.NatsSource;
...
public class SourceTests extends TestBase {
                                    ...
                                    String connectionPropertiesFile) throws Exception
    {
        ...
        NatsPayloadSourceBuilder<String> builder = new NatsPayloadSourceBuilder<String>()
            .subjects(subject)
